...
<a href = "<?php print $go_sef; ?>" target="_top"><?php print JText::_('GO_TO_'.$lang.'_MINI') ?></a>
</span>
<?php if ($type_view=="1"){?>
<span class="modal_checkout <?php if (($jshopConfig->min_price_order && $cart->getSum(0,1)<$jshopConfig->min_price_order) || ($jshopConfig->max_price_order && $cart->getSum(0,1)>$jshopConfig->max_price_order))print 'dnone-force';?>">
