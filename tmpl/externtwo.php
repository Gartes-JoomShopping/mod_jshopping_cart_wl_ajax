...
<div>
  ...
  <span class="mini_cart_img"><a title="<?php print JText::_('GO_TO_'.$lang.'_MINI') ?>" href = "<?php print $go_sef; ?>" target="_top"><img src="/modules/mod_jshopping_cart_wl_ajax/assets/img/<?php print $del_sef;?>_mini.png" /></a></span>
 <div class="clear"></div>   
