...
?>
       <a href = "<?php print $go_sef; ?>" target="_top"> <div>
            <span class="mycart_mini_txt <?php print str_replace("_:","",$layout); ?>" title="<?php print JText::_('PRODUCTS_AT_'.$lang.'_MINI') ?> <?php print $cart->count_product;?> <?php print JText::_('PRODUCTS_SUMM_MINI') ?> <?php print strip_tags(formatprice($cart->getSum(0,1)))?>">
                <span class="count_comparel"><?php print $cart->count_product;?></span>
            </span>
        </div>
          
        <?php if (($show_added_to_cart_icon=='1') || ($show_added_to_cart_icon_prod=='1')){ ?>
